...
<h1 class="text-4xl font-bold underline text-center my-8 uppercase bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500 lg:mt-20">Svelte Kit Pokedex</h1>
